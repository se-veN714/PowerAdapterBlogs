"""Import deployment-safe Apple Music aggregates from normalized JSON."""
...
DEFAULT_SOURCE = Path(__file__).resolve().parents[2] / "data" / "apple_music_records.json"


class Command(BaseCommand):
    help = "Import normalized Apple Music aggregates idempotently for deployment."
